                                ...
                                <div class="">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="public_type" v-model="publicType" value="1"> 一般公開
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="public_type" v-model="publicType" value="2"> 限定公開
                                        </label>
                                    </div>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" type="radio" name="public_type" v-model="publicType" value="3"> 非公開
                                        </label>
                                    </div>
                                </div>
                                <div class="mt-4">
            ...
            onSubmit() {
                this.$nextTick(() => {
                    ...
                    let quiz = {
                        ...
                        quizSubTitle: this.quizSubTitle,
